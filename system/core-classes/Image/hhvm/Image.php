...
/****** Class Variables ******/
	public string $mime = "";			// <str> The mime-type of the image.
	public int $width = 0;			// <int> The width of the image.
	public int $height = 0;			// <int> The height of the image.
	public mixed $resource = null;	// <mixed> the image resource.
	
	
/****** Constructor ******/
	public function __construct
	(
		string $imagePath = ""		// <str> The filepath of the base image to create from, or empty for a blank image.
	,	int $width = 0			// <int> The width of the image (if applicable)
	,	int $height = 0			// <int> The height of the image (if applicable)
	,	string $extType = ""		// <str> The type of extension (if applicable)
	): void						// RETURNS <void>
...
# Note: This function MUCH faster than the "layer" method (like 200x faster), so use this whenever possible.
	...
	(
		string $layerPath			// <str> A path to the image you'd like to layer on top.
	,	int $posX = 0			// <int> Destination X position of the layer (from crop).
	,	int $posY = 0			// <int> Destination Y position of the layer (from crop).
	,	int $layerX = 0			// <int> Source X position.
	,	int $layerY = 0			// <int> Source Y position.
	,	int $layerWidth = 0		// <int> Width of the layer. (default is actual size)
	,	int $layerHeight = 0	// <int> Height of the layer. (default is actual size)
	): void						// RETURNS <void>
...
# Formulas found by Kevin Jensen, http://www.venture-ware.com/kevin/coding/lets-learn-math-photoshop-blend-modes/
	...
	(
		string $mode				// <str> The layering mode to use.
	,	string $layerPath			// <str> A path to the image you'd like to layer on top.
	,	int $posX = 0			// <int> Destination X position of the layer (from crop).
	,	int $posY = 0			// <int> Destination Y position of the layer (from crop).
	,	int $layerX = 0			// <int> Source X position.
...
# Note: this function is incredibly slow, and "paste" may operate 200x faster for you.
	...
	(
		string $layerPath			// <str> A path to the image you'd like to layer on top.
	,	int $posX = 0			// <int> X position of the layer.
	,	int $posY = 0			// <int> Y position of the layer.
	,	int $layerX = 0			// <int> X crop-position of layer.
	,	int $layerY = 0			// <int> Y crop-position of layer.
	,	int $layerWidth = 0		// <int> Width of the layer. (default is actual size)
	,	int $layerHeight = 0	// <int> Height of the layer. (default is actual size)
	): void						// RETURNS <void>
...
/****** Blend an Image Layer ******/
	...
	(
		string $layerPath			// <str> A path to the image you'd like to blend.
	,	int $posX = 0			// <int> X position of the layer.
	,	int $posY = 0			// <int> Y position of the layer.
	,	int $layerX = 0			// <int> X crop-position of layer.
	,	int $layerY = 0			// <int> Y crop-position of layer.
...
/****** Overlay an Image Layer ******/
	...
	(
		string $layerPath			// <str> A path to the image you'd like to overlay.
	,	int $posX = 0			// <int> X position of the layer.
	,	int $posY = 0			// <int> Y position of the layer.
	,	int $layerX = 0			// <int> X crop-position of layer.
	,	int $layerY = 0			// <int> Y crop-position of layer.
...
/****** Multiply the Image ******/
	...
	(
		string $layerPath				// <str> The image path of the layer to multiply.
	,	int $posX = 0				// <int> X position of the image (to start multiplier).
	,	int $posY = 0				// <int> Y position of the image (to start multiplier).
	,	int $layerX = 0				// <int> X crop-position of layer.
	,	int $layerY = 0				// <int> Y crop-position of layer.
	,	int $layerWidth = 0			// <int> Width of the layer. (default is actual size)
	,	int $layerHeight = 0		// <int> Height of the layer. (default is actual size)
...
/****** Crop Image ******/
	...
	(
		int $x			// <int> The X position to start cropping at.
	,	int $y			// <int> The Y position to start cropping at.
	,	int $toX		// <int> The X position to stop cropping at.
	,	int $toY		// <int> The Y position to stop cropping at.
	): void				// RETURNS <void>
...
# This function automatically creates a center-cropped image (of the size chosen).
	...
	(
		int $width		// <int> The width of the cropped image.
	,	int $height		// <int> The height of the cropped image.
	): void				// RETURNS <void>
...
# This function forces a strict width with a flexible height, and centers the height.
	...
	(
		int $width			// <int> The forced width of the image.
	,	int $maxHeight = 0	// <int> The maximum height for the image. 0 = no maximum.
	): void					// RETURNS <void>
...
# This function forces a strict height with a flexible width, and centers the width.
	...
	(
		int $height			// <int> The forced width of the image.
	,	int $maxWidth = 0	// <int> The maximum width for the image. 0 = no maximum.
	): void					// RETURNS <void>
...
/****** Create a Thumbnail of an Image ******/
	...
	(
		int $width = 100	// <int> The width of the thumbnail.
	,	int $height = 100	// <int> The height of the thumbnail.
	): void					// RETURNS <void>
...
/****** Find the Crop Box (used by trimTransparency()) ******/
	...
	(
		int $posX			// <int> The x position of where to start searching on the image.
	,	int $posY			// <int> The y position of where to start searching on the image.
	,	int $posX2			// <int> The x position of where to stop searching.
	,	int $posY2			// <int> The y position of where to stop searching.
	,	int $gridSize = 5	// <int> Precision of the grid search (larger number = less precise, true = exact)
	): array <int, int>					// RETURNS <int:int> list($x, $y, $x2, $y2) - the rectangle of detected boxes. 
...
/****** Scale Image ******/
	...
	(
		int $newWidth		// <int> The new width of the image (scaled proportionally).
	,	int $newHeight		// <int> The new height of the image (scaled proportionally).
	,	int $x = 0			// <int> The upper-left X boundary for what part of your image you want to scale.
	,	int $y = 0			// <int> The upper-left Y boundary for what part of your image you want to scale.
	,	int $x2 = 0			// <int> The bottom-right X boundary to scale. (default is max width)
	,	int $y2 = 0			// <int> The bottom-right Y boundary to scale. (default is max width)
	): void					// RETURNS <void>
...
/****** Swap Colors in an Image ******/
	...
	(
		array <int, int> $swapFrom		// <int:int> The RGB color array that you'd like to swap from.
	,	array <int, int> $swapTo			// <int:int> The RGB color array of what you'd like to swap to.
	): void					// RETURNS <void> 
...
/****** Colorize the Image ******/
	...
	(
		int $red			// <int> The red influence for the colorization.
	,	int $green			// <int> The green influence for the colorization.
	,	int $blue			// <int> The blue influence for the colorization.
	,	int $alpha = 0		// <int> The alpha influence for the colorization.
	): void					// RETURNS <void> 
...
/****** Recolor a single flat-colored Layer ******/
	...
	(
		string $layerPath			// <str> A path to the image you'd like to layer on top.
	,	string $color				// <str> A hex color code.
	,	bool $isoutline			// <bool> true if the layer is an outline.
	,	int $posX = 0			// <int> Destination X position of the layer (from crop).
	,	int $posY = 0			// <int> Destination Y position of the layer (from crop).
	,	int $layerX = 0			// <int> Source X position.
	,	int $layerY = 0			// <int> Source Y position.
...
/****** Pixelate the Image ******/
	...
	(
		int $blockSize = 2			// <int> The block size you want to use for pixelation.
	,	bool $advanced = false		// <bool> True for advanced pixelation.
	): void							// RETURNS <void> 
...
# Note: This was modified from an original script by Tatu Ulmanen on Stack Overflow.
	...
	(
		int $angle			// <int> The degree of hue shift you'd like to change, up to 360 degrees.
	): void					// RETURNS <void>
...
/****** Change Hex Color to RGB Color ******/
	...
	(
		string $hexColor		// <str> The hex color value that you want to change to rgb.
	): array <int, int>					// RETURNS <int:int> array($red, $green, $blue)
...
/****** Change RGB Color to Hex Color ******/
	...
	(
		int $red		// <int> The number to represent the red value in RGB
	,	int $green		// <int> The number to represent the green value in RGB
	,	int $blue		// <int> The number to represent the blue value in RGB
	): string				// RETURNS <str> The resulting hex color value
...
/****** Prepare a New Image ******/
	...
	(
		string $file				// <str> The file where you'd like to save the image.
	,	int $quality = 90		// <int> The level of quality (only affects jpg)
