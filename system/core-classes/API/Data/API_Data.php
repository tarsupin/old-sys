...
--------------------------------------
------ About the API_Data Class ------
--------------------------------------

This class is used to track and provide site data for other sites on the network, which is required for APIs to function.
...
API_Data::syncConnection($siteHandle, [$syncBoth], [$newKey]);

// Set the data you will use with another site
$key = API_Data::setData($siteHandle, $siteName, $siteURL, [$siteClearance], [$siteKey], [$overwrite]);
...
/****** Retrieve API Data for a particular site ******/
...
/****** Set Site Data ******/
	...
	// $key = API_Data::setData($siteHandle, $siteName, $siteURL, [$siteKey], [$overwrite]);
