...
/****** Prepare special tags and protection for a Link ******/
	...
	(
		string $clickVal = "1"		// <str> A secret click value to pass.
	): string						// RETURNS <str> encryption code to append to the link.
...
/****** Validate a Link Click using Special Protection ******/
	...
	): string					// RETURNS <str> a string identifier for which click was made, "" on failure.
...
/****** Get the data from a link ******/
	...
	(
		string $origClickVal	// <str> The click value that was originally used.
	): array <int, mixed>					// RETURNS <int:mixed> an array of data sent through the link, array() on failure.
...
/****** Maintain associations in a query string ******/
	...
	): string		// RETURNS <str> the query string that results.
