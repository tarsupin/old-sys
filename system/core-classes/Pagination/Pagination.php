...
/****** Construct the Pagination Object ******/
	...
	(
		$numberOfResults		// <int> The total number of results to paginate.
	,	$resultsPerPage			// <int> The number of results to show per page.
	,	$currentPage			// <int> The current page.
	,	$mode = "standard"		// <str> The pagination mode to run.
	,	$pageRange = 4			// <int> The range of pagination to use.
	)							// RETURNS <void>
...
/****** Set the type of pagination to use ******/
	...
	(
		$mode				// <str> The pagination mode to run.
	,	$pageRange = 4		// <int> The range of pagination to use.
	)						// RETURNS <void>
