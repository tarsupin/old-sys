...
------------------------------------------------------------------------
------ About the "You" Class (the user you are actively viewing) ------
------------------------------------------------------------------------
...
/****** Prepare Variables ******/
	public static $id = 0;			// <int> The UniID of the "You" user
	public static $name = "";		// <str> The display name of the "You" user
	public static $handle = "";		// <str> The user handle of the "You" user
	
	
/****** Load "You" (the user being viewed or interacted with) ******/
	public static function load
	(
		$uniID			// <int> The ID of the Uni-Account to load.
