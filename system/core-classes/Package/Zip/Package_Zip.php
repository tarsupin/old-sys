...
Standard zipping and unzipping of files is very easy:
	...
	// Zip a directory
	Package_Zip::package("/path/to/directory", "/path/to/save/zipfile.zip");
	
	// Zip a text file
	Package_Zip::package("/path/to/file.txt", "/path/to/save/zipfile.zip");
	
	// Unzip a zipped package
	Package_Zip::unpackage("/path/to/zipfile.zip", "/path/to/unpackage");
...
If you want to have the zip file also include it's parent name, set the third parameter $incParent to true.
	...
	Package_Zip::package("/path/to/directory", "/path/to/save/zipfile.zip", true);
...
Package_Zip::package($source, $targetFile)				// Takes the contents of a directory and zips them up.
Package_Zip::unpackage($sourceFile, $targetDirectory)	// Unzips the contents of a directory into the target folder.
...
/****** Zip a Directory ******/
	...
	// Package_Zip::package('/path/to/compress/', './compressed.zip');
	{
...
/****** Unzip a Zipped File into a Directory ******/
	...
	// Package_Zip::unpackage('./compressed.zip', '/path/to/unzip/in/');
	{
