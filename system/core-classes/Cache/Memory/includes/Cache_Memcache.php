...
/****** Set Cached Variable ******/
	...
	// Cache_Memory::set("usersOnline", "100", $expire, $expireFlux);
	{
		$expire = time() + $expire;
...
/****** Get Cached Variable ******/
	...
	// $value = Cache_Memory::get("usersOnline");
	{
...
/****** Check if a Cached Variable exists ******/
	...
	// if(Cache_Memory::exists("usersOnline")) { echo "Value exists."; }
	{
...
/****** Delete a Cached Variable ******/
	...
	// Cache_Memory::delete("usersOnline");
	{
