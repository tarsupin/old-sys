...
-----------------------------------------
------ About the Upload_File Class ------
-----------------------------------------

This class handles the uploading of files, including performing validations.
...
if(Form::submitted("upload-file"))
{
	...
	$fileUpload = new Upload_File($_FILES['myFile']);
...
/****** Save the file ******/
	...
	,	$mode = 0		// <int> The save mode to use.
