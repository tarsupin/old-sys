...
/****** Save a Site Value ******/
	...
	(
		$keyGroup		// <str> The key group to save the key in.
	,	$keyName		// <str> The key to save.
	,	$value			// <mixed> the value or integer to set the configuration to.
	,	$table = ""		// <str> The database table to use (defaults to `site_variables`)
...
/****** Retrieve a Site Value (or multiple values within a shared group) ******/
	...
	(
		$keyGroup		// <str> The key group to retrieve.
	,	$keyName = ""	// <str> The key to retrieve (if empty, the function returns the entire key group).
	,	$table = ""		// <str> The database table to use (defaults to `site_variables`)
	)					// RETURNS <mixed> The value stored, or FALSE on failure.
...
/****** Delete a Site Value ******/
	...
	(
		$keyGroup		// <str> The key group to delete keys from.
	,	$keyName = ""	// <str> The key to delete (if empty, the function will delete the entire key group).
	,	$table = ""		// <str> The database table to use (defaults to `site_variables`)
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
