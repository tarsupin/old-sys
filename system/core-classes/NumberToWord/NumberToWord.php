...
--------------------------------------------
------ About the Number-To-Word Class ------
--------------------------------------------

This plugin allows integers to be converted to human words.

To translate a number to a human word, use the following structure:
	
	echo NumberToWord::convert(22);		// Outputs "twenty two".
...
/****** Change Number to Word ******/
	...
	// echo NumberToWord::convert(1022);	// Outputs "one thousand twenty two"
	{
