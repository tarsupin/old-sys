...
# Failure to properly sanitize user input from a downloaded value is incredibly insecure.
	...
	,	string $savePath = ""		// <str> The path to save the file to (saves within SITE_PATH).
	,	bool $baseDir = false	// <bool> TRUE if you want to use the base directory instead of SITE_PATH.
