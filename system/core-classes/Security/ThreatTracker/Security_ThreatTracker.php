...
----------------------------------------------------
------ About the Security_ThreatTracker Class ------
----------------------------------------------------
...
To use this system, just use the Security_ThreatTracker::log() method to capture any data you feel might be suspicious.
...
-----------------------------------------
	...
	{
		Security_ThreatTracker::log(
			$_GET['file_to_load']
		,	Security_ThreatTracker::THREAT_LETHAL
...
Security_ThreatTracker::pruneThreats($severity, $pruneDuration);

*/

abstract class Security_ThreatTracker {
...
/****** Set the Security_ThreatTracker Mode ******/
	...
	// Security_ThreatTracker::setMode(Security_ThreatTracker::MODE_LOG_ALL, Security_ThreatTracker::THREAT_HIGH);
	// Security_ThreatTracker::setMode(Security_ThreatTracker::MODE_LOG_ACTIVITY);
	{
		switch($mode)
		{
			case self::MODE_OFF:
...
/****** Log data into Security_ThreatTracker ******/
