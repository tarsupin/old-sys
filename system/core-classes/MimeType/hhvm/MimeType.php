...
------------------------------------------
------ About the MimeType Class ------
------------------------------------------

This plugin provides simple tools for working with and identifying mime types.

The most important role of this plugin is to provide a list of valid mime types for a large number of extensions.

-------------------------------
------ Methods Available ------
-------------------------------

$mimeType = MimeType::get($extension);		// Retrieve a mime type from an extension
...
/****** Class Variables ******/
	...
	,	'arc'	=> array("application/octet-stream", "application/x-freearc")
	...
	,	'book'	=> array("application/book", "application/vnd.framemaker")
	...
	,	'class'	=> array("application/java", "application/java-byte-code", "application/x-java-class", "application/java-vm")
	...
	,	'com'	=> array("application/octet-stream", "text/plain", "application/x-msdownload")
	...
	,	'dp'	=> array("application/commonground", "application/vnd.osgi.dp")
	...
	,	'dxf'	=> array("application/dxf", "image/vnd.dwg", "image/x-dwg", "image/vnd.dxf")
	...
	,	'elc'	=> array("", "application/x-elc", "application/octet-stream")
	...
	,	'flo'	=> array("image/florian", "application/vnd.micrografx.flo")
	...
	,	'h'	=> array("text/plain", "text/x-h", "text/x-c")
	...
	,	'hh'	=> array("text/plain", "text/x-h", "text/x-c")
	,	'hlb'	=> array("text/x-script")
	,	'hlp'	=> array("application/hlp", "application/x-helpfile", "application/x-winhelp", "application/winhlp")
	...
	,	'jam'	=> array("audio/x-jam", "application/vnd.jam")
	...
	,	'lha'	=> array("application/lha", "application/octet-stream", "application/x-lha", "application/x-lzh-compressed")
	...
	,	'lzh'	=> array("application/octet-stream", "application/x-lzh", "application/x-lzh-compressed")
	...
	,	'm3u'	=> array("audio/x-mpequrl", "audio/x-mpegurl")
	...
	,	'man'	=> array("application/x-troff-man", "text/troff")
	,	'manifest'	=> array("text/cache-manifest")
	,	'map'	=> array("application/x-navimap")
	,	'mar'	=> array("text/plain", "application/octet-stream")
	...
	,	'mcd'	=> array("application/mcad", "application/x-mathcad", "application/vnd.mcd")
	...
	,	'me'	=> array("application/x-troff-me", "text/troff")
	...
	,	'mif'	=> array("application/x-frame", "application/x-mif", "application/vnd.mif")
	...
	,	'mpc'	=> array("application/x-project", "application/vnd.mophun.certificate")
	...
	,	'mpt'	=> array("application/x-project", "application/vnd.ms-project")
	...
	,	'ms'	=> array("application/x-troff-ms", "text/troff")
	...
	,	'pdb'	=> array("chemical/x-pdb", "application/vnd.palm")
	...
	,	'pic'	=> array("image/pict", "image/x-pict")
	,	'pict'	=> array("image/pict")
	,	'pkg'	=> array("application/x-newton-compatible-pkg", "application/octet-stream")
	...
	,	'pre'	=> array("application/x-freelance", "application/vnd.lotus-freelance")
	,	'prf'	=> array("application/pics-rules")
	,	'prt'	=> array("application/pro_eng")
	,	'ps'	=> array("application/postscript")
	,	'psb'	=> array("application/vnd.3gpp.pic-bw-small")
	,	'psd'	=> array("application/octet-stream", "image/vnd.adobe.photoshop", "image/photoshop", "image/x-photoshop", "image/psd", "application/photoshop", "application/psd", "zz-application/zz-winassoc-psd")
	...
	,	'rmi'	=> array("audio/mid", "audio/midi")
	...
	,	'roff'	=> array("application/x-troff", "text/troff")
	...
	,	'scm'	=> array("application/x-lotusscreencam", "text/x-script.guile", "text/x-script.scheme", "video/x-scm", "application/vnd.lotus-screencam")
	...
	,	'sid'	=> array("audio/x-psid", "image/x-mrsid-image")
	...
	,	'skd'	=> array("application/x-koan", "application/vnd.koan")
	,	'skm'	=> array("application/x-koan", "application/vnd.koan")
	,	'skp'	=> array("application/x-koan", "application/vnd.koan")
	,	'skt'	=> array("application/x-koan", "application/vnd.koan")
	...
	,	'smi'	=> array("application/smil", "application/smil+xml")
	...
	,	'vox'	=> array("audio/voxware", "application/x-authorware-bin")
	...
	,	'vsd'	=> array("application/x-visio", "application/vnd.visio")
	,	'vsf'	=> array("application/vnd.vsf")
	,	'vss'	=> array("application/vnd.visio")
	,	'vst'	=> array("application/x-visio", "application/vnd.visio")
	,	'vsw'	=> array("application/x-visio", "application/vnd.visio")
	,	'vtt'	=> array("text/vtt")
	...
	,	'wmf'	=> array("windows/metafile", "application/x-msmetafile")
	...
	,	'wpd'	=> array("application/wordperfect", "application/x-wpwin", "application/vnd.wordperfect")
	...
	,	'wri'	=> array("application/mswrite", "application/x-wri", "application/x-mswrite")
	...
	,	'xla'	=> array("application/excel", "application/x-excel", "application/x-msexcel", "application/vnd.ms-excel")
	...
	,	'xlt'	=> array("application/excel", "application/x-excel", "application/vnd.ms-excel")
...
/****** Get allowed mime types from an extension ******/
	public static function get
	(
		string $extension			// <str> The extension to get the mime type for.
	): array <int, str>						// RETURNS <int:str> the mime type of the related extension, array() if not found.
