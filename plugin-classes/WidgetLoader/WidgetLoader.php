...
/****** Class Variables ******/
	public static $slots = array();		// <str:[int:array]> Stores widget data in a designated container.
...
/****** Load widgets from the database ******/
	...
	(
		$container = ""		// <str> If set, only load widgets for the designated container.
	)						// RETURNS <void>
...
/****** Add a static entry into the Widget Loader ******/
	...
	(
		$container		// <str> The name of the container to load a static widget into.
	,	$sortOrder		// <int> The sort order (position) to load the static widget into.
	,	$html			// <str> The block of HTML to add as a widget into the loader.
	)					// RETURNS <void>
...
/****** Return a list of widgets in a container ******/
	...
	(
		$container		// <str> The name of the container to load widgets from.
