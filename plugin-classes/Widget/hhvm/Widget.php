...
/****** Widget Variables ******/
	public string $content = "";		// <str> The HTML content of the widget.
...
/****** Load this widget into the WidgetLoader ******/
	...
	(
		string $container			// <str> The HTML to load into the widget.
	,	int $sortOrder = 99		// <int> The sort order to load this widget into.
	): void						// RETURNS <void>
