...
<div id="footer">
	...
	<div id="footer-middle">
		<a href="' . $uniCom . '/contact">Contact</a> | <a href="' . $uniCom . '/faqs">FAQs</a> | <a href="' . $uniCom . '/privacy">Privacy</a> | <a href="' . $uniCom . '/user-panel/reports">Report</a> | <a href="' . $uniCom . '/acknowledgements">Thanks</a> | <a href="' . $uniCom . '/tos">TOS</a>
	</div>
	<div id="footer-right">
		<div id="ftbutton">
