...
For example, the URL "/action/MyClassX/Jump?param[0]=value&param[1]=value2" would run:
	
	MyClassX_Meta::Jump_TeslaAction($_GET['param'][0], $_GET['param'][1], Me::$clearance);
...
For example, a typical action call will look similar to this:
	...
	/action/ClassName/actionName?param[0]=firstParameter&param[1]=secondParameter
	
	
----------------------------------------
------ Example of a Class Action ------
----------------------------------------
