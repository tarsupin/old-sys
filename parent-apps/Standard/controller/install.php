...
<br />Environments are where your site is hosted. A "Production Environment" generally refers to the server that is hosting your site that everyone will see, while a "Staging Environment" or "Local Environment" might refer to servers that only YOU have access to for testing and debugging purposes.
...
<p><a class="button" href="/install/config-server">Begin the Installation</a></p>';
